...
import { TemplateImportView } from '@/components/templates/TemplateImportView';
...
function AppContent({ children }: { children: React.ReactNode }) {
  ...
  if (isTemplateImportOpen) {
    return (
      <TemplateImportView onClose={() => setIsTemplateImportOpen(false)} />
    );
  }
  ...
  return (
    <>
      ...
      <Header
        ...
        onOpenImportTemplate={() => setIsTemplateImportOpen(true)}
      />
